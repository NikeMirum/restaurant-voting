...
public class VoteTestData {
    ...
    public static final Vote vote2 = new Vote(VOTE1_ID + 1, admin, restaurant1, OLD_DATE);
    public static final Vote vote3 = new Vote(VOTE1_ID + 2, user, restaurant1, CURRENT_DATE);
    ...
    public static Vote getUpdated() {
        return new Vote(VOTE1_ID + 2, user, restaurant2, CURRENT_DATE);
    }
}
