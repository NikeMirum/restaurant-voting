...
public class VoteTestData {
    public static final MatcherFactory.Matcher<Vote> MATCHER = MatcherFactory.usingIgnoringFieldsComparator(Vote.class, "restaurant", "user", "date");
    ...
    public static final Vote vote2 = new Vote(VOTE1_ID + 1, admin, restaurant1, CURRENT_DATE);
    public static final Vote vote3 = new Vote(VOTE1_ID + 2, user, restaurant1, OLD_DATE);
    public static final Vote vote4 = new Vote(VOTE1_ID + 3, admin, restaurant2, OLD_DATE);
}
